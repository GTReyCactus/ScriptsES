...
function scavenge() {
    ...
    // Comprobar página o redireccionar
    ...
    let lackadaisicalLooters = document.getElementsByClassName("title")[0].innerHTML;
    let humbleHaulers = document.getElementsByClassName("title")[1].innerHTML;
    let cleverCollectors = document.getElementsByClassName("title")[2].innerHTML;
    let greatGatherers = document.getElementsByClassName("title")[3].innerHTML;

    // Factores y tiempos
    let duration_factor = window.ScavengeScreen.village.options[1].base.duration_factor;
    let duration_exponent = window.ScavengeScreen.village.options[1].base.duration_exponent;
    let duration_initial_seconds = window.ScavengeScreen.village.options[1].base.duration_initial_seconds;



    // Establecer el tiempo de recolección y guardarlo en local
    ...
    if ($('button').length == 0) {
        ...
        // Contador de usos para los desarrolladores originales
