...
var translations = {
    ...
    es_ES: {
        'Map Barbs Only': 'Mapa de Bárbaros',
        Help: 'Ayuda',
        'Script must be executed from the <a href="/game.php?screen=map" class="btn">Map</a>':
            'El script debe ser ejectuado en el <a href="/game.php?screen=map" class="btn">Mapa</a>',
        'Script is already loaded and running!': '¡El script ya está cargado y funcionando!',
    },
};
