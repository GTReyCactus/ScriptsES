var version = "1.13.1";
var scriptName = "LA Enhancer (1.13.1) - Port By ReyCactus";
var scriptURL = "https://gtreycactus.github.io/ScriptsES/";
var updateNotesURL = "";
var working = true;
...
function checkVersion() {
    if (getVersion() != version) {
        ...
        if (clearProfiles) {
            ...
            Dialog.show("update_dialog", "Este script ha sido recientemente actualizado a la versión <span style='font-weight:bold;'>" + version + "</span> y para que pueda funcionar correctamente todos los perfiles y ajustes deben reiniciarse. Disculpar las molestias...<br /><br/><a href='" + updateNotesURL + "' target='_blank'>Ver novedades</a>.</br></br></br>Disfrutar!</br>Ibra Gonza II | Port y traducción de ReyCactus");
        }
    } else {
    }
}
